 ...
 */
public class Java110ListenerServiceDiscoveryRegistrar implements ImportBeanDefinitionRegistrar,ResourceLoaderAware, BeanClassLoaderAware {

    private ResourceLoader resourceLoader;

    private ClassLoader classLoader;

    public Java110ListenerServiceDiscoveryRegistrar(){
    ...
    public void registerListener(AnnotationMetadata metadata,
        ...
        Map<String, Object> attrs = metadata
                .getAnnotationAttributes(Java110ListenerServiceDiscovery.class.getName());
                    ...
                    if (beanDefinition.getMetadata().isInterface()
                        ...
                        try {
                            Class<?> target = ClassUtils.forName(
                                    ...
                                    Java110ListenerServiceDiscoveryRegistrar.this.classLoader);
    ...
    protected Set<String> getBasePackages(AnnotationMetadata importingClassMetadata) {
        Map<String, Object> attributes = importingClassMetadata
                .getAnnotationAttributes(Java110ListenerServiceDiscovery.class.getCanonicalName());
